...
for subj in "${subj_list[@]}"; do
	...
	freeview -v $t1dir/$subj/mri/T1.mgz $t1dir/$subj/mri/aparc+aseg.mgz:colormap=lut:opacity=0.2 -viewport 'y' -slice 128 128 102 -nocursor -screenshot $t1dir/group_qc/grotd.png
	...
	freeview -v $t1dir/$subj/mri/T1.mgz $t1dir/$subj/mri/aparc+aseg.mgz:colormap=lut:opacity=0.2 -viewport 'y' -slice 128 128 154 -nocursor -screenshot $t1dir/group_qc/grotf.png
	freeview -v $t1dir/$subj/mri/T1.mgz $t1dir/$subj/mri/aparc+aseg.mgz:colormap=lut:opacity=0.2 -viewport 'z' -slice 128 102 128 -nocursor -screenshot $t1dir/group_qc/grotg.png
	...
	freeview -v $t1dir/$subj/mri/T1.mgz $t1dir/$subj/mri/aparc+aseg.mgz:colormap=lut:opacity=0.2 -viewport 'z' -slice 128 154 128 -nocursor -screenshot $t1dir/group_qc/groti.png
	cd $t1dir/group_qc/
