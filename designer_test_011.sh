...
designerdir=$projectdir/designer_011/$j/
...
singularity exec --nv --bind $basedir $basedir/neurodock_latest.sif pydesigner -s --resume --verbose --fit_constraints 0,1,1 -o $designerdir $rawdwi.nii.gz
